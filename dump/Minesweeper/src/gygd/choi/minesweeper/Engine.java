...
public class Engine 
{
	 ...
	 */
	public Engine(int rows, int cols, int mines) 
	{
	...
	public void show() 
	{
		...
		// true-cover
		// false-uncover
		System.out.println(this.toString(true)); // Switch to false
		try 
		{
			Thread.sleep(100);
		} 
	...
	public void takeTurn() {
		...
		System.out.println("Pick a square: rowNum colNum");
		this.uncoverSquare(sc.nextInt(), sc.nextInt());
	}
